  ...
  render() {
    return (
      <Modal show={this.state.OSUShow} onHide={this.props.onHide}>
        ...
        <Modal.Body>
          <p>During my time at OSU, I always enjoyed courses that involved web development, and appreciated the freedom we had in selecting the tech stack that we were going to use. I loved learning the many Javascript frameworks, and various back-end options. At OSU, I was able to build apps using Ruby on Rails, Spring, NodeJS, AngularJS, and vanilla Javascript.</p>
