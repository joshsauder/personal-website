      ...
      <div className="tab-pane fade show active" id={list.name} role="tabpanel">
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="mt-3">
                <Button variant="outline-secondary" className="mr-2 mb-2 mb-md-0" target="_blank" href={list.github}><FontAwesomeIcon className="github" icon={['fab', 'github']}/> Github Repo</Button>
