  ...
  render() {
    return (
      <Modal show={this.state.NTIShow} onHide={this.props.onHide}>
          ...
          <Modal.Body>
          <p>I am currently working with customers to complete any projects they are currently working on (system migrations, upgrades, new data endpoints, etc), and solving any issues they run into. This typically involves replicating what they are trying to accomplish or the issue they are experiencing.</p>
          ...
          <p>On top of the above list, this job really involves a lot of communication. I have numerous meetings with customers (both scheduled and after-hours when an outage occurs or production issue occurs), and this job requires that you are able to quickly identify the issue at hand and find a resolution, and also explain technical detail in a concise and efficient manner.</p>
          </Modal.Body>
          <Modal.Footer>
