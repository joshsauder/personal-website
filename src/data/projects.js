...
export const InTheClearPlansList = [
    "Allow the user to save cities, and implement a table that shows a list of planned stops along with detailed weather information.",
    "Implement a sign in screen once the web app (see below) is complete.",
    "Allow the routes to be exported to Apple Maps. Currently, only Google Maps is supported."
]