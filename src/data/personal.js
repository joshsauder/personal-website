export const ProfessionalList = [
    "My goal, as a developer, is to create applications that better the users life. I truly believe software can positively impact a persons life and help make the world a much better place!",
    ...
    "During my Co-op at CAS, I found that I really enjoyed web development and learning the various Javascript frameworks and backend options. I also really enjoyed working with the other developers to build web apps and find ways to make other employees jobs easier.",
...
export const WhatIKnowList = [
    "Languages and Frameworks - Javascript, AngularJS, ReactJS, HTML5, CSS, Bootstrap, NodeJS, ExpressJS, Spring MVC, MSSQL, MySQL, Java, Swift",
